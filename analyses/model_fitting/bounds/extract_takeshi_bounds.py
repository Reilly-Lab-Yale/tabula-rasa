"""
Extract Bounds presets from all 4 takeshi phantom orthos.

Mirrors extract_shendure_bounds.py, except: tgzs are written to
...
OUT_DIR = Path(__file__).parent / "output" / "takeshi"
