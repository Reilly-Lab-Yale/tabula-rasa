#!/usr/bin/env python
"""
Cohen NB-only by-cell-type fit (consider_missing=True, GPU).
...
name = "cohen_cm_nb_20260329_by_cell_type"
...
cluster = SLURMCluster(
    ...
    job_extra_directives=[
        ...
        "--job-name=cohen_cm_nb_ct_w", "--time=12:00:00",
...
#SBATCH -A prio_skr2
#SBATCH --job-name=cohen_cm_nb_ct_gpu
#SBATCH -t 1-00:00:00
#SBATCH -c 1
#SBATCH --mem=64G
