#!/usr/bin/env python
"""
Cohen NB-only by-CRE fit (consider_missing=True, CPU).
Counterpart to cohen_cm_zinb_20260329 for NB vs ZINB comparison.
...
name = "cohen_cm_nb_20260329_by_cre"
...
cluster = SLURMCluster(
    ...
    job_extra_directives=[
        ...
        "--job-name=cohen_cm_nb_cre_w", "--time=12:00:00",
...
try:
    if (path / name).is_dir():
        ...
        primordial.fit_by_cre_models(client=client, dat=cohen, nb_only=True)
