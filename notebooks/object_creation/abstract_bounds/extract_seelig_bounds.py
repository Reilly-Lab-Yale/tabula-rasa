"""
Extract Bounds presets from all 4 seelig phantom orthos.
...
ORTHOS = [
    "seelig_cm_zinb_phantom",
    "seelig_cm_nb_phantom",
]
# Note: seelig has no obs condition (no transfection reporter, so consider_missing
# is always on -- there is no meaningful "obs" fit).
